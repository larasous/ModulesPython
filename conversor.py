...
if sys.platform == 'linux':
    ...
    comando_ffmpeg = r'ffmpeg\ffmpeg.exe' # Para Windows
...
debug = '-ss 00:00:00 -to 00:00:10'  # converter os 10 segundos
debug = ''  # converter o vídeo todo

caminho_origem = '/home/lara/Vídeos'
caminho_destino = '/home/lara/Vídeos/saida'
